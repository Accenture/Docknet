...
def test_generate_class_sample(data_generator1):
    ...
    plot_scatter(axes[0], sample0[0, :], sample0[1, :], (1, 0, 0), x_range, y_range, "Island")
    plot_scatter(axes[1], sample1[0, :], sample1[1, :], (0, 0, 1), x_range, y_range, "Sea")
...
def test_generate_sample(data_generator1):
    ...
    axe = plt.subplot()
    plot_scatter(axe, X[0, :], X[1, :], Y[0, :], x_range, y_range, "Island & sea sample")
